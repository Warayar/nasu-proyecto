...
const QueEsNasu = () => {
    ...
    return (
        <div className="container-Inicio">
            ...
            <div className="Segunda-section">
                ...
                <div className="image-container">
                    <img src={require('../Imagenes/Inicio/captura2.png')} alt="Image 1" />
                ...
                <div className="image-container">
                    <img src={require('../Imagenes/Inicio/captura3.png')} alt="Image 2" />
                    <div className="image-content">
                ...
                {/* Image 3 */}
                <div className="image-container">
                    <img src={require('../Imagenes/Inicio/captura4.png')} alt="Image 3" />
                    <div className="image-content">
        ...
        <img src={require('../Imagenes/Inicio/captura6.png')} alt="Image 3" />
        </div>

        {/* Title and description list on the right */}
    ...
    <img src={require('../Imagenes/Inicio/captura7.png')} alt="Image 3" />
    </div>
...
<div>
    ...
    <div className="septima-section">
        ...
        <img src={require('../Imagenes/Inicio/captura10.png')} alt="Image 3" />
            <h3>RITA ARGUEDAS</h3>
...
<img src={require('../Imagenes/Inicio/captura5.png')} alt="Image 3" />
</div>

{/* Content to the left */}
<div className="octava-content">
<p>Con tu membresía a NASU hacés una importante donación a:</p>
    <img src={require('../Imagenes/Inicio/captur11.png')} alt="Image 3" />
